namespace Terrasoft.Configuration
{
	...
	public class UsrYachtEventsSchema : Terrasoft.Core.SourceCodeSchema
	{
		...
		protected override void InitializeProperties() {
			...
			UId = new Guid("a4ae0aa9-27c3-40cc-bc79-3094cbdbc2a9");
			Name = "UsrYachtEvents";
			ParentSchemaUId = new Guid("50e3acc0-26fc-4237-a095-849a1d534bd3");
			CreatedInPackageId = new Guid("421ddd98-311d-4efb-8878-4dad8c2c1627");
		...
		protected virtual SchemaLocalizableString CreateValueIsTooBigLocalizableString() {
			SchemaLocalizableString localizableString = new SchemaLocalizableString() {
				UId = new Guid("29dfd177-d805-c452-0143-56d318801cf6"),
				Name = "ValueIsTooBig",
				CreatedInPackageId = new Guid("421ddd98-311d-4efb-8878-4dad8c2c1627"),
				CreatedInSchemaUId = new Guid("a4ae0aa9-27c3-40cc-bc79-3094cbdbc2a9"),
				ModifiedInSchemaUId = new Guid("a4ae0aa9-27c3-40cc-bc79-3094cbdbc2a9")
			};
		...
		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			...
			realUIds.Add(new Guid("a4ae0aa9-27c3-40cc-bc79-3094cbdbc2a9"));
		}
